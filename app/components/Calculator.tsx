...
interface UIStrings {
  ...
  destKeys: string[]
  signPreview: string; downloadBtn: string; shareWaBtn: string; shareNote: string
  result: {
...
const UI: Record<Lang, UIStrings> = {
  ...
  en: {
    ...
    shareWaBtn: 'Share directly to WhatsApp',
  ...
  ro: {
    ...
    shareWaBtn: 'Trimite direct pe WhatsApp',
  ...
  de: {
    ...
    shareWaBtn: 'Direkt auf WhatsApp teilen',
  ...
  it: {
    ...
    shareWaBtn: 'Condividi direttamente su WhatsApp',
  ...
  fr: {
    ...
    shareWaBtn: 'Partager directement sur WhatsApp',
...
export default function Calculator() {
  ...
  async function shareImage() {
    ...
    try {
      ...
      const file = new File([blob], 'sign-preview-xdsign.png', { type: 'image/png' })
      if (navigator.canShare({ files: [file] })) {
        await navigator.share({ files: [file], title: 'XD Sign Preview', text: buildWaText() })
      }
    } catch {}
  }
                  ...
                  <div className="mb-8">
                    ...
                    <div className="mt-3 flex flex-wrap items-center gap-3">
                      ...
                      {canShare && (
                        <button
                          onClick={shareImage}
                          className="flex items-center gap-2 px-4 py-2.5 bg-[#25D366] hover:bg-[#20b857] text-white text-xs font-semibold tracking-wide transition-colors"
                        >
                      ...
                      {!canShare && <p className="text-white/30 text-xs">{ui.shareNote}</p>}
                    </div>
                  </div>
                )}
